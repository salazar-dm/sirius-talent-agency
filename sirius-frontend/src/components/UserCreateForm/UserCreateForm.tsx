...
import {emptyProfile, emptyUser} from "../../dummy-data/emptyProfile.ts";

const UserCreateForm: React.FC = () => {
    const navigate = useNavigate();

    const [profile, setProfile] = useState<PerformerProfileType>(emptyProfile);
    const [user, setUser] = useState<LocalUserType>(emptyUser);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_URL}/api/admin/users`, userPayload, {
                headers: {
            ...
            setErrorModalMessage('Something went wrong during creation.');
            setErrorModal(true);
        } finally {
                    ...
                    <div className="Grid_grid__container Grid_grid__container__margin"
                        ...
                        <div className="Grid_grid__item"
                            ...
                            <div className="Signpost__signpost-container">
                                <p className="Signpost__eyebrow">Create</p>
                                <h3 className="Signpost__title">Create User Account</h3>
                                <p className="Signpost__body">Role is preset to "Performer"</p>
                            </div>
                        </div>
                        <div className="Grid_grid__item"
